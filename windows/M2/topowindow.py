...
class CustomFrequencyDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.low_freq_spin.setRange(0.1, 200.0)
        ...
        self.high_freq_spin.setRange(0.1, 200.0)
...
class TopographyWidget(QWidget):
    ...
    def compute_psd_power(self, data, freq_band=(5, 15)):
        ...
        for channel in data.columns:
            ...
            if len(signal) < 256:  # Not enough data
                continue
    ...
    def _create_boundary_mask(self, grid_x, grid_y):
    ...
    def plot_power_on_head(self, power_values, ax=None, colorbar_ax=None, theme_colors=None, show_labels=True):
        ...
        # Apply boundary mask - only show data inside electrode boundary
        boundary_mask = self._create_boundary_mask(grid_x, grid_y)
